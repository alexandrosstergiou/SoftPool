...
template <>
struct n_limits<bool> {
  static inline __host__ __device__ bool lowest() { return false; }
  static inline __host__ __device__ bool min() { return false; }
...
template <>
struct n_limits<int8_t> {
  static inline __host__ __device__ int8_t lowest() { return INT8_MIN; }
  static inline __host__ __device__ int8_t min() { return INT8_MIN; }
...
template <>
struct n_limits<int16_t> {
  static inline __host__ __device__ int16_t lowest() { return INT16_MIN; }
  static inline __host__ __device__ int16_t min() { return INT16_MIN; }
...
template <>
struct n_limits<int32_t> {
  static inline __host__ __device__ int32_t lowest() { return INT32_MIN; }
  static inline __host__ __device__ int32_t min() { return INT32_MIN; }
...
struct n_limits<int64_t> {
  ...
  static inline __host__ __device__ int64_t min() { return INT64_MIN; }
...
template <>
struct n_limits<at::Half> {
  static inline __host__ __device__ at::Half lowest() { return at::Half(0xFBFF, at::Half::from_bits()); }
  static inline __host__ __device__ at::Half min() { return at::Half(0x0400, at::Half::from_bits()); }
...
template <>
struct n_limits<at::BFloat16> {
  static inline __host__ __device__ at::BFloat16 lowest() { return at::BFloat16(0xFF7F, at::BFloat16::from_bits()); }
  static inline __host__ __device__ at::BFloat16 min() { return at::BFloat16(0x0080, at::BFloat16::from_bits()); }
